...
import { Lightbulb, BookMarked, Rocket, ArrowRight } from "lucide-react"
...
const steps = [
  {
    ...
    description:
      "На первом занятии выясняем текущий уровень знаний, определяем пробелы и ставим конкретные цели — будь то успеваемость, олимпиада или экзамен.",
    number: "01",
  },
  {
    icon: BookMarked,
    title: "Системное изучение",
    description:
      "Выстраиваем чёткую структуру знаний: работаем с теорией, первоисточниками и практическими заданиями. Каждая тема закрепляется на практике.",
    number: "02",
  },
  {
    icon: Rocket,
    ...
    description:
      "Регулярно проверяем прогресс через тесты и контрольные работы. Корректируем план при необходимости и идём к уверенному результату.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">первого урока</span> к <span className="text-primary">результату</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Три простых шага, которые превращают «не понимаю» в «всё получается».
          </p>
        </div>
