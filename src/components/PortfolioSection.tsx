...
const tests = [
  ...
  },
  {
    ...
    description:
      "Ещё один тест по истории на платформе Яндекс Формы. Проверь знания в удобном формате — вопросы охватывают ключевые темы и исторические события.",
    url: "https://forms.yandex.ru/cloud/6a0cfc2795add54cccdbc9fe",
    tags: ["История", "Яндекс Формы", "Самопроверка"],
    emoji: "🗺️",
  },
  {
